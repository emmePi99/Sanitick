...
describe('AuthService', () => {
  ...
  describe('register', () => {
    ...
    it('should create a user if not exists', async () => {
      ...
      mockUserCoreService.create.mockResolvedValue({
        id: '1',
        email: 'test@test.com',
      });
  ...
  describe('login', () => {
    ...
    it('should throw InvalidCredentialException if password invalid', async () => {
      mockUserCoreService.findOneByEmailWithPassword.mockResolvedValue({
        id: '1',
        password: 'hashed',
      });
  ...
  describe('setPassword', () => {
    it('should throw NotFoundException if token is invalid', async () => {
      mockUserCoreService.findOneBy.mockResolvedValue(null);
      await expect(
        service.setPassword({ token: 'invalid', password: 'new' }),
    ...
    it('should throw BadRequestException if token is expired', async () => {
      ...
      await expect(
        service.setPassword({ token: 'expired', password: 'new' }),
